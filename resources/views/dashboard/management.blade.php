        ...
        <div class="col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm hover-card">
                <div class="card-body text-center p-4 d-flex flex-column">
                    ...
                    <p class="card-text text-muted small flex-grow-1">Deep dive into faculty workload distribution and
                        balance.</p>
                    <a href="{{ route('management.dashboard') }}" class="btn btn-outline-primary btn-sm mt-auto">View
                        Dashboard</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm hover-card">
                <div class="card-body text-center p-4 d-flex flex-column">
                    ...
                    <p class="card-text text-muted small flex-grow-1">Compare performance metrics between departments.</p>
                    <a href="{{ route('management.department_comparison') }}"
                        class="btn btn-outline-warning btn-sm mt-auto">Compare Now</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm hover-card">
                <div class="card-body text-center p-4 d-flex flex-column">
                    ...
                    <p class="card-text text-muted small flex-grow-1">Download comprehensive reports in CSV/Excel format.
                    </p>
                    <a href="{{ route('management.export_reports') }}" class="btn btn-outline-danger btn-sm mt-auto">Go to
                        Export</a>
                </div>
            </div>
        </div>
