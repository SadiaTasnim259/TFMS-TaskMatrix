            ...
            <form action="{{ route('admin.task-forces.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <small class="form-text text-muted">Will be generated automatically (e.g., TF-{{ date('Y') }}-XXXXX)</small>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                               ...
                               placeholder="e.g., Curriculum Development Committee" required>
                        @error('name')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01" min="1.0" max="{{ $maxWorkload }}" 
                               class="form-control @error('default_weightage') is-invalid @enderror" 
                               id="default_weightage" name="default_weightage" 
                               value="{{ old('default_weightage', 2.00) }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-check form-switch mt-2">
                            <input class="form-check-input" type="checkbox" id="active" name="active" 
                                   value="1" @if(old('active', true)) checked @endif>
