        ...
        <div class="card-body">
            <form action="{{ route('admin.task-forces.store') }}" method="POST">
                ...
                <div class="row">
                    <!-- Academic Year -->
                    <div class="col-md-6 mb-3">
                        <label for="academic_year" class="form-label">Academic Session <span
                                class="text-danger">*</span></label>
                        @if(isset($currentSession))
                            <input type="hidden" name="academic_year" value="{{ $currentSession->academic_year }}">
                        ...
                        @else
                            ...
                            <div class="invalid-feedback">Please configure an active academic session first.</div>
                        @endif
                        @error('academic_year')
