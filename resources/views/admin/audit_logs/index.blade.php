            ...
            <form method="GET" action="{{ route('admin.audit-logs.index') }}" class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="search" class="form-control" 
                           placeholder="Model name, description..." 
                ...
                <div class="col-md-2">
                    ...
                    <select name="model_type" class="form-select">
                        ...
                        @foreach($modelTypes as $type)
                            <option value="{{ $type }}" 
                                    @if(request('model_type') === $type) selected @endif>
                                {{ $type }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-2">
                    ...
                    <select name="status" class="form-select">
                        ...
                        <option value="completed" @if(request('status') === 'completed') selected @endif>Success</option>
                    ...
                    @forelse($logs as $log)
                        <tr>
                            ...
                            <td>
                                @if($log->user)
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-circle bg-primary bg-opacity-10 text-primary me-2" style="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%;">
                            ...
                            <td>
                                ...
                                @endphp
                                <span class="badge bg-{{ $actionClass }} bg-opacity-10 text-{{ $actionClass }} border border-{{ $actionClass }}">
                                    {{ $log->action }}
                                </span>
                            </td>
