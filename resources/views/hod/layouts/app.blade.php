            ...
            <div class="col-md-3 col-lg-2 sidebar p-3">
                <nav class="nav flex-column">
                    ...
                    @if(auth()->user()->isLecturer())
                        ...
                        <a class="nav-link @if(request()->routeIs('workload.index')) active @endif"
                            href="{{ route('workload.index') }}">
                            📂 My Workload
                        </a>
                        <a class="nav-link @if(request()->routeIs('workload.create')) active @endif"
                            href="{{ route('workload.create') }}">
                            📝 New Submission
                        </a>
                    @endif
                    ...
                    @if(auth()->user()->hasRole('management'))
                        ...
                        <a class="nav-link @if(request()->routeIs('management.export')) active @endif"
                            href="{{ route('management.export') }}">
                            📥 Data Export
                        </a>
                    @endif
                </nav>
